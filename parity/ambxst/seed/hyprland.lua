...
hl.config({
    general = {
        ...
        border_size = 2,
        col = {
            active_border = "rgb(95bcfb)",
            inactive_border = "rgb(2f3041)",
        },
        layout = "scrolling",
    },
    decoration = {
...
hl.bind("SUPER + ALT + TAB", hl.dsp.exec_cmd("ambxst run overview"))
...
hl.bind("SUPER + G", hl.dsp.exec_cmd("/home/nethum/.local/bin/tool-ring"))
